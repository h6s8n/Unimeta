...
public:
    //--- Constructor
    CDrawManager(SSettings* settings, CTrendAnalyzer* analyzer)
    {
        m_settings = settings;
        m_analyzer = analyzer;
        m_atr = 0;
    ...
    void DrawTrendLine(string name, datetime time1, double price1, 
                      datetime time2, double price2, color line_color)
    {
    ...
    void DisplayAngle(string base_name, datetime time1, double price1, 
                     datetime time2, double price2)
    {
        ...
        ObjectSetString(0, angle_name, OBJPROP_TEXT, 
            StringFormat("%.1f° (%.1f)", angle, length));
    ...
    void HighlightTrendLine(string name, double length)
    {
        ...
        if(last_highlighted != "")
        {
            ...
            ObjectSetInteger(0, last_highlighted, OBJPROP_COLOR, 
                price2 > price1 ? clrLime : clrRed);
        ...
        ObjectSetString(0, infoBoxName, OBJPROP_TEXT, 
            "Last Valid Line Length = " + DoubleToString(length, 1));
